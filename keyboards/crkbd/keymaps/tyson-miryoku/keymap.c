...
,
// #elif defined TYSON_MIRYOKU_CUSTOM
//   [BASE] = LAYOUT_split_3x6_3(
//     U_NU,   KC_Q,          KC_W,          KC_F,              KC_P,             KC_G,              KC_J,            KC_L,             KC_U,            KC_Y,            KC_QUOT,      U_NU,
//     KC_ESC, LGUI_T(KC_A),  LALT_T(KC_R),  LCTL_T(KC_S),      LSFT_T(KC_T),     KC_D,              KC_H,            LSFT_T(KC_N),     LCTL_T(KC_E),    LALT_T(KC_I),    LGUI_T(KC_O), U_NU,
//     U_NU,   KC_Z,          ALGR_T(KC_X),  KC_C,              KC_V,             KC_B,              KC_K,            KC_M,             KC_COMM,         ALGR_T(KC_DOT),  KC_SLSH,      U_NU,
